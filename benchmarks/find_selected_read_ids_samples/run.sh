...
echo "pod5"
/benchmark-tools/time.py "pod5" -- /benchmark-tools/find_and_get_pod5.py /input_path/pod5_files /benchmark/outputs/pod5_files --select-ids /benchmark/outputs/read_ids.csv  --get-column samples
