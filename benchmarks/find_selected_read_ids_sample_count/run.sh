...
echo "mkr c_api"
/benchmark-tools/time.py "mkr_c_api" -- /benchmark-tools/find_and_get_mkr.py /input_path/mkr_files_c_api /benchmark/outputs/mkr_files_c_api --select-ids /benchmark/outputs/read_ids.csv  --get-column sample_count --c-api

echo "mkr pyarrow"
/benchmark-tools/time.py "mkr_pyarrow" -- /benchmark-tools/find_and_get_mkr.py /input_path/mkr_files_pyarrow /benchmark/outputs/mkr_files_pyarrow --select-ids /benchmark/outputs/read_ids.csv  --get-column sample_count
