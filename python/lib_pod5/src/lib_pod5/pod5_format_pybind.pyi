...
class FileWriter:
    ...
    def add_reads(
        ...
        channels: npt.NDArray[np.uint32],
        ...
        expected_open_pore_levels: npt.NDArray[np.float32],
        selected_read_levels: npt.NDArray[np.float32],
...
class Pod5FileReader:
    ...
    def get_original_file_version(self) -> str: ...
    def get_logical_file_version(self) -> str: ...
    def get_physical_read_table_version(self) -> int: ...
    def get_logical_read_table_version(self) -> int: ...
    def plan_traversal(
        self,
