...
inline pod5::Status write_section_marker(std::shared_ptr<arrow::io::OutputStream> const& sink,
...
inline pod5::Status write_combined_header(std::shared_ptr<arrow::io::OutputStream> const& sink,
                                          boost::uuids::uuid const& section_marker) {
...
inline pod5::Status write_footer(std::shared_ptr<arrow::io::OutputStream> const& sink,
                                 boost::uuids::uuid const& section_marker,
                                 boost::uuids::uuid const& file_identifier,
                                 std::string const& software_name,
                                 FileInfo const& signal_table,
