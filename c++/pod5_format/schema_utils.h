...
inline arrow::Result<int> find_dict_field(std::shared_ptr<arrow::Schema> const& schema,
                                          char const* name,
    ...
    *value_type = std::dynamic_pointer_cast<ValueType>(type->value_type());
    if (!*value_type) {
        return Status::TypeError("Dictionary value was unexpected type: ",
...
public:
    ...
    static Status read_schema(std::shared_ptr<SchemaDescriptionBase> dest_schema,
...
class FieldBase {
public:
    FieldBase(SchemaDescriptionBase* owner,
              int field_index,
              std::string name,
...
struct Field : public FieldBase {
    ...
    Field(SchemaDescriptionBase* owner,
          std::string name,
          std::shared_ptr<arrow::DataType> const& datatype,
          TableSpecVersion added_table_spec_version = TableSpecVersion::first_version(),
          TableSpecVersion removed_table_spec_version = TableSpecVersion::unknown_version())
...
struct ListField : public Field<WriteIndex_, ArrayType_> {
    ...
    ListField(SchemaDescriptionBase* owner,
              std::string name,
              std::shared_ptr<arrow::DataType> const& datatype,
              TableSpecVersion added_table_spec_version = TableSpecVersion::first_version(),
              TableSpecVersion removed_table_spec_version = TableSpecVersion::unknown_version())
            : Field<WriteIndex_, ArrayType_>(owner,
                                             name,
                                             datatype,
                                             added_table_spec_version,
                                             removed_table_spec_version) {}
