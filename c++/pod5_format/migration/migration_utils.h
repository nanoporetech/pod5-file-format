...
arrow::Result<std::shared_ptr<arrow::Array>> make_filled_array(arrow::MemoryPool* pool,
...
inline arrow::Status set_column(std::shared_ptr<arrow::Schema> const& schema,
...
inline arrow::Status copy_column(std::shared_ptr<arrow::Schema> const& schema_a,
...
struct Pod5BatchRecordWriter {
    ...
    arrow::Status write_batch(std::size_t num_rows,
...
inline pod5::Result<Pod5BatchRecordReader> open_record_batch_reader(
    ...
    ARROW_ASSIGN_OR_RAISE(result.reader,
                          arrow::ipc::RecordBatchFileReader::Open(file, read_options));
...
inline pod5::Result<Pod5BatchRecordWriter> make_record_batch_writer(
    ...
    ARROW_ASSIGN_OR_RAISE(result.writer,
                          arrow::ipc::MakeFileWriter(file, schema, write_options, metadata));
