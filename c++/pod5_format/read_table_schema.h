...
POD5_FORMAT_EXPORT std::shared_ptr<arrow::Schema> make_read_table_schema(
        std::shared_ptr<const arrow::KeyValueMetadata> const& metadata,
        ReadTableSchemaDescription* field_locations);

POD5_FORMAT_EXPORT Result<std::shared_ptr<ReadTableSchemaDescription>> read_read_table_schema(
