...
PYBIND11_MODULE(pod5_format_pybind, m)
{
    ...
    py::class_<Pod5FileReaderPtr>(m, "Pod5FileReader")
        ...
        .def("get_original_file_version", &Pod5FileReaderPtr::get_original_file_version)
        .def("get_logical_file_version", &Pod5FileReaderPtr::get_logical_file_version)
        .def("get_physical_read_table_version", &Pod5FileReaderPtr::get_physical_read_table_version)
        .def("get_logical_read_table_version", &Pod5FileReaderPtr::get_logical_read_table_version)
